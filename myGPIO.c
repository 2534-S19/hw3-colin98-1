...
void initGPIO()
{
    ...
    GPIO_setOutputLowOnPin(GPIO_PORT_P1, GPIO_PIN0 || GPIO_PIN1 || GPIO_PIN4);
    GPIO_setOutputLowOnPin(GPIO_PORT_P2, GPIO_PIN0 || GPIO_PIN1 || GPIO_PIN2 || GPIO_PIN4 || GPIO_PIN6);
    GPIO_setOutputLowOnPin(GPIO_PORT_P3, GPIO_PIN5);
    GPIO_setOutputLowOnPin(GPIO_PORT_P1, GPIO_PIN1 || GPIO_PIN6);
